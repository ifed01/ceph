...
// a pattern which identifies the beginning of a snap diff request
// parameter following snapshots root path provided by a client. Once detected
// twice at proper locations within the path the relevant client operation is
// considered as a snapdiff request and handled accordingly. 
// The full request format is as follows:
// <snapshots root folder>/.~diff=<snap1>.diff=<snap2>
//
// E.g. /mnt/mycephfs/dir0/.snap/.~diff=snap1.~diff=snap2
//
