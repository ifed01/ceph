...
protected:
  ...
  uint64_t last_outdated_page_seqno = 0;	      // last page seq got commit confirmation
  ...
  uint64_t min_pending_seqno = 1;
  uint64_t max_pending_seqno = 0;
...
public:
  ...
  static const size_t DEF_BLOCK_SIZE = 0x1000;
  ...
  void committed(uint64_t outdated_page_seqno);
