...
class TransparentBackend : public PGBackend {
...
public:
  ...
  PGBackend::RecoveryHandle *open_recovery_op() override {
    return nullptr; //FIXME TRANSPARENT _open_recovery_op();
  }
...
private:
  ...
  uint64_t be_get_ondisk_size(uint64_t logical_size) const override { return logical_size; }
};
